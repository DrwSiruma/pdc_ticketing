<?php 
    ...
    $ticket_num = $_GET['id'];
    $stmt = $conn->prepare("SELECT tr.*, t.id AS ticket_id, t.sched_end FROM tbl_tickets t LEFT JOIN tbl_ticketreport tr ON t.ticket_num = tr.ticket_num WHERE tr.ticket_num = ?");
        ...
        <form method="post" id="ticketForm" action="update-treport?id=<?php echo $ticket_num; ?>" enctype="multipart/form-data">
            <div class="report-container">
                    ...
                    <div class="report-section-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Time In:</label>
                                    <input type="time" class="form-control" name="time_in" value="<?php echo !empty($ticket_row['time_in']) ? date('H:i', strtotime($ticket_row['time_in'])) : ''; ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Time Out:</label>
                                    <input type="time" class="form-control" name="time_out" value="<?php echo !empty($ticket_row['time_out']) ? date('H:i', strtotime($ticket_row['time_out'])) : ''; ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="6" name="findings" readonly><?php echo !empty($ticket_row['findings']) ? $ticket_row['findings'] : ''; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Action Taken:</label>
                                    <textarea class="form-control" rows="6" name="action" readonly><?php echo !empty($ticket_row['action']) ? $ticket_row['action'] : ''; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Diagnosis:</label>
                                    <textarea class="form-control" rows="6" name="diagnosis" readonly><?php echo !empty($ticket_row['diagnosis']) ? $ticket_row['diagnosis'] : ''; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Recommendation(s):</label>
                                    <textarea class="form-control" rows="6" name="recom" readonly><?php echo !empty($ticket_row['recom']) ? $ticket_row['recom'] : ''; ?></textarea> 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="report-section-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Signature:</label>
                                    <canvas id="personnelSignature" width="400" height="150" style="border: 1px solid #ccc; pointer-events: none; background-color: #f9f9f9;"></canvas>
                ...
                <div class="report-footer">
                    ...
                    <a href="my-ticket?id=<?php echo $ticket_row['ticket_id']; ?>" class="btn btn-secondary">Cancel</a>
