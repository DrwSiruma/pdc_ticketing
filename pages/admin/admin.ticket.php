...
?>
    ...
    <div class="container-fluid">
        ...
        <ul class="nav nav-pills mb-3" id="ex-with-icons" role="tablist">
            ...
            <li class="nav-item position-relative" role="presentation">
                <a class="nav-link" id="ex-with-icons-tab-2" data-toggle="pill" data-target="#ex-with-icons-tabs-2" role="tab"
            ...
            <li class="nav-item position-relative" role="presentation">
                <a class="nav-link" id="ex-with-icons-tab-3" data-toggle="pill" data-target="#ex-with-icons-tabs-3" role="tab"
                aria-controls="ex-with-icons-tabs-3" aria-selected="false"><i class="fas fa-calendar-times fa-fw me-2"></i>Overdue</a>
